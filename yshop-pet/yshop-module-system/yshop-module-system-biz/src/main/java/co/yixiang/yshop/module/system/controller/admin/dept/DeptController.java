package co.yixiang.yshop.module.system.controller.admin.dept;
...
public class DeptController {
    ...
    @Operation(summary = "获取我部门信息列表", description = "只包含被开启的部门，主要用于前端的下拉选项")
    public CommonResult<List<DeptSimpleRespVO>> getAccessDeptList() {
        List<DeptDO> list = deptService.getDeptList(
                new DeptListReqVO().setIsAccess(true).setStatus(CommonStatusEnum.ENABLE.getStatus()));
        return success(BeanUtils.toBean(list, DeptSimpleRespVO.class));
    }
