...
public class UserController {
    ...
    @Operation(summary = "获取用户精简信息列表", description = "只包含被开启的用户，主要用于前端的下拉选项")
    public CommonResult<List<UserSimpleRespVO>> getAccessUserList() {
        List<Long> ids = new ArrayList<>();
        Long LoginUid = SecurityFrameworkUtils.getLoginUserId();
        ids.add(LoginUid);
        ids.addAll(adminUserApi.getUserListBySubordinateIds(LoginUid));
