...
public interface StoreProductService extends IService<StoreProductDO> {
     ...
     * 导入商品
     *
     * @param importProducts 导入商品列表
     * @param cateId 商品分类编号（必填，导入商品均归属该分类）
     * @return 导入结果
     */
    StoreProductImportRespVO importStoreProductList(List<StoreProductImportExcelVO> importProducts, Long cateId);
