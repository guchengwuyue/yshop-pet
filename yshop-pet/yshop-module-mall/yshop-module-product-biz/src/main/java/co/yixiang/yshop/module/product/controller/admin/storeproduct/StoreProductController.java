...
public class StoreProductController {
    ...
    public CommonResult<PageResult<StoreProductRespVO>> getStoreProductPage(@Valid StoreProductPageReqVO pageVO) {
        return success(storeProductService.getStoreProductPage(pageVO));
    }
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        List<StoreProductImportExcelVO> list = Arrays.asList(
                StoreProductImportExcelVO.builder()
                        ...
                        .cost(5.0)
                        .otPrice(12.0)
                        .inventoryWarningEnable(1)
                        .inventoryWarningNumber(10)
                        .build(),
                StoreProductImportExcelVO.builder()
                        .storeName("示例商品B")
                        .unitName("盒")
        ...
        ExcelUtils.write(response, "商品导入模板.xls", "商品列表", StoreProductImportExcelVO.class, list);
    }
