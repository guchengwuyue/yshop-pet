<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="短名" prop="shortName">
        <el-input
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['stock:supplier:create']"
        >
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['stock:supplier:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['stock:supplier:delete']"
          >
            删除
          </el-button>
        </template>
...
/** 供应商 列表 */
defineOptions({ name: 'StockSupplier' })
