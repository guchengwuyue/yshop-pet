<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="PC端跳转地址" prop="pcUrl">
        <el-input  v-model="formData.pcUrl" placeholder="请输入PC端跳转地址" />
      </el-form-item>
      <el-form-item label="手机端跳转地址" prop="mobileUrl">
        <el-input  v-model="formData.mobileUrl" placeholder="请输入手机端跳转地址" />
      </el-form-item>
...
const formRules = reactive({
  pcUrl: [{ required: true, message: 'PC端跳转地址不能为空', trigger: 'blur' }],
  mobileUrl: [{ required: true, message: '手机端跳转地址不能为空', trigger: 'blur' }],
